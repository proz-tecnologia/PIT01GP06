                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownButtonFormField(
                            ...
                            items:
                                despesasController.listaCategorias.map((item) {
                          ...
                          _categoria == 'Cartão Crédito'
                              ...
                              : DropdownButtonFormField<String>(
                                  ...
                                  items:
                                      despesasController.getListaSubcategorias(
                                          _indexSelecionado)),
                          const SizedBox(
                            height: 30,
                          ),
                          ...
                          (_contaOuCartao == 'Conta' && bankAccounts != null) ||
                                  (_contaOuCartao == 'Cartão' &&
                                      cardAccounts != null)
                              ? DropdownButtonFormField(
                              ...
                              : const Text(
                                  'Adicione alguma carteira à sua conta.'),
                          const SizedBox(
                            height: 30,
                          ),
                          const Text(
                        ...
                        if (_formKey.currentState?.validate() ?? false) {
                          if (_selectedValue != null) {
                            ...
                            DespesasModel despesaModel = DespesasModel(
                                ...
                                balance:
                                    _valorController.numberValue + totalBalance,
